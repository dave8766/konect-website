        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full md:w-2/12 mb-8 md:mb-0">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white">Coaches</a></li>
            ...
            <form>
              <div className="flex flex-wrap md:flex-nowrap">
                <input
                  ...
                  className="w-full md:w-auto flex-grow px-4 py-2 mb-2 md:mb-0 md:mr-2 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 text-gray-900"
                />
                <button
                  type="submit"
                  className="w-full md:w-auto bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded-md transition duration-300"
                >
                  Subscribe
                </button>
              </div>
