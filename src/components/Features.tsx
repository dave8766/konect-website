  ...
  const features = [
    {
      ...
      description: "Access fitness, nutrition, mobility, and sport-specific training all in one place.",
      icon: (
    ...
    },
    {
      ...
      description: "Connect with elite, verified coaches who specialize in your specific fitness goals.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Receive customized workout plans and nutrition advice tailored to your specific needs.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Monitor your improvements with detailed analytics and progress reports.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Chat directly with your coaches for real-time feedback and support.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
